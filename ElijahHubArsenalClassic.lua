...
local Window = OrionLib:MakeWindow({Name = "Elijah Hub | Arsenal | Classic Event", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
