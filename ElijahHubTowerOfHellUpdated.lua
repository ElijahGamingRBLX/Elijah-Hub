...
local Window = OrionLib:MakeWindow({Name = "Elijah Hub - Tower Of Hell", HidePremium = false, SaveConfig = true, IntroEnabled = true, IntroText = Elijah Hub, ConfigFolder = "OrionTest"})
...
Tab2:AddButton({
	...
	Callback = function()
      		loadstring(game:HttpGet('https://raw.githubusercontent.com/ElijahGamingRBLX/Elijah-Scripts/main/TeleportGUIV2.lua'))()
  	end    
})
